...
export default function AcademicsPage() {
  ...
  return (
    <div className="bg-offwhite min-h-screen pt-20 flex flex-col">
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto text-center">
        <h2 className="text-2xl md:text-3xl font-bold text-navy-midnight mb-6 tracking-tight">Comprehensive CBSE Framework</h2>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 container mx-auto bg-white border-t border-border flex-1">
        <div className="text-center mb-16">
          <div className="inline-block text-[11px] font-bold tracking-widest text-slate uppercase mb-4">Educational Stages</div>
          <h2 className="text-3xl md:text-4xl font-bold text-navy-midnight mb-5 tracking-tight">Our School Levels</h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 max-w-7xl mx-auto pb-24">
          {levels.map((level) => (
            <div key={level.id} className="bg-white border border-border flex flex-col group hover:-translate-y-0.5 hover:border-gold-flame hover:shadow-xl hover:shadow-navy-midnight/5 transition-all duration-200">
              <div className="aspect-[4/3] bg-offwhite border-b border-border p-4 flex flex-col items-center justify-center relative overflow-hidden">
              ...
              <div className="p-8 relative flex-1 flex flex-col">
                <div className="text-2xl font-bold text-gold-flame/40 mb-4 font-serif tracking-widest">{level.id}.</div>
                <h3 className="text-xl font-bold text-navy-midnight mb-1 tracking-tight">{level.title}</h3>
                <p className="text-gold-flame text-xs font-bold uppercase tracking-widest mb-4">{level.grades}</p>
                <p className="text-slate text-sm leading-relaxed font-medium mt-auto">{level.desc}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="w-full bg-gold-flame py-16 px-4 text-center">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="h-[2px] w-16 bg-white/30 mx-auto mb-6"></div>
