      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 pt-16 pb-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            <h2 className="text-2xl font-bold text-navy-deep mb-6">Get in Touch</h2>

            <div className="bg-white p-6 rounded-xl border border-border shadow-sm flex items-start gap-4">
              <div className="bg-pearl p-3 rounded-full">
                <Phone className="w-6 h-6 text-gold-crest" />
              </div>
              <div>
                <h3 className="font-bold text-navy-deep">Phone</h3>
                <p className="text-slate mt-1">9848591617, 8978261617, 8341141617</p>
              </div>
            </div>

            <div className="bg-white p-6 rounded-xl border border-border shadow-sm flex items-start gap-4">
              <div className="bg-pearl p-3 rounded-full">
                <Mail className="w-6 h-6 text-gold-crest" />
              </div>
              <div>
                <h3 className="font-bold text-navy-deep">Email</h3>
                <p className="text-slate mt-1">scvidyanikethan@gmail.com</p>
              </div>
            </div>

            <div className="bg-white p-6 rounded-xl border border-border shadow-sm flex items-start gap-4">
              <div className="bg-pearl p-3 rounded-full">
                <MapPin className="w-6 h-6 text-gold-crest" />
              </div>
              <div>
                <h3 className="font-bold text-navy-deep">Address</h3>
                <p className="text-slate mt-1">J.P. Colony, Road No. 1, Patancheru</p>
              </div>
            </div>

            <div className="bg-white p-6 rounded-xl border border-border shadow-sm flex items-start gap-4">
              <div className="bg-pearl p-3 rounded-full">
                <Clock className="w-6 h-6 text-gold-crest" />
              </div>
              <div>
                <h3 className="font-bold text-navy-deep">Timings</h3>
                <p className="text-slate mt-1">8:00am to 6:00pm</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-border shadow-sm p-8">
            <h2 className="text-2xl font-bold text-navy-deep mb-6">Send a Message</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 rounded-md border border-border focus:outline-none focus:ring-2 focus:ring-gold-crest focus:border-transparent text-navy-deep"
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-2 rounded-md border border-border focus:outline-none focus:ring-2 focus:ring-gold-crest focus:border-transparent text-navy-deep resize-none"
              ...
              <button
                ...
                className="w-full py-3 px-4 bg-gold-crest hover:bg-gold-flame text-navy-deep font-bold rounded-md transition-colors shadow-sm disabled:opacity-70"
              >
